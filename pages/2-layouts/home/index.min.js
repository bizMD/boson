...
return oe.noConflict=function(t){return e.$===oe&&(e.$=Wt),t&&e.jQuery===oe&&(e.jQuery=Mt),oe},t||(e.jQuery=e.$=oe),oe})},{}],2:[function(e,t,n){var r;(r=e("jquery"))(function(){return socket.on("time left",function(e){return r(".timer").html(""+e)}),socket.on("begin exam",function(){return r(".button").removeAttr("disabled")}),socket.on("end exam",function(){return r(".button").attr("disabled",!0)}),r(".button").click(function(){return window.location="/exam"})})},{jquery:1}]},{},[2])
