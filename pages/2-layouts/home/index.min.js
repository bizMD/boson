...
return oe.noConflict=function(t){return e.$===oe&&(e.$=It),t&&e.jQuery===oe&&(e.jQuery=Mt),oe},t||(e.jQuery=e.$=oe),oe})},{}],2:[function(e,t,n){var r;(r=e("jquery"))(function(){return socket.on("begin exam",function(){return r(".button").prop("disabled",!1),r(".button").html("Start Test")}),socket.on("time left",function(e){return r(".timer").html(""+e)}),socket.on("end exam",function(){return r(".button").prop("disabled",!0),r(".button").html("Test Is Over"),r(".timer").html("0:00")}),socket.on("user id",function(e){return localStorage.setItem("user id",e.key),localStorage.setItem("exam id",e.id),window.location="/exam"}),r(".button").click(function(){return socket.emit("user registered")})})},{jquery:1}]},{},[2])
