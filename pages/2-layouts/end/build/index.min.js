...
return oe.noConflict=function(t){return e.$===oe&&(e.$=It),t&&e.jQuery===oe&&(e.jQuery=Mt),oe},t||(e.jQuery=e.$=oe),oe})},{}],2:[function(e,t,n){var r
socket.emit("authenticate user",localStorage.getItem("user id")),(r=e("jquery"))(function(){return socket.on("time left",function(e){return r(".timer").html(""+e)}),socket.on("end exam",function(){return socket.emit("request for user score",localStorage.getItem("user id"))})})},{jquery:1}]},{},[2])
