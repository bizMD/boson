...
return oe.noConflict=function(t){return e.$===oe&&(e.$=Wt),t&&e.jQuery===oe&&(e.jQuery=Mt),oe},t||(e.jQuery=e.$=oe),oe})},{}],2:[function(e,t,n){var r,i
r=e("jquery"),i=function(e){switch(e){case"Enable":return r(".status").html("active"),r(".toggle").html("disable"),r(".button").html("Disable")
case"Disable":return r(".status").html("inactive"),r(".toggle").html("enable"),r(".button").html("Enable")}},r(function(){return socket.on("time left",function(e){return r(".timer").html(""+e)}),socket.on("cannot toggle",function(e){return console.log("Cannot toggle")}),socket.on("end exam",function(){return i("Disable")}),r(".button").click(function(){return"0:00"===r(".timer").html()?!1:(socket.emit("toggle exam",!0),i(r(".button").html()))})})},{jquery:1}]},{},[2])
