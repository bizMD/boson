...
r=e("jquery"),o=function(e){switch(e){case"Start":return r(".status").html("active"),r(".toggle").html("conclude"),r(".button").html("Stop")
case"Stop":return r(".status").html("inactive"),r(".toggle").html("enable"),r(".button").html("Start")}},i=function(){return r(".button").remove(),r(".instructions").remove(),r(".status").html("concluded"),r(".timer").html("0:00")},r(function(){return socket.on("time left",function(e){return r(".timer").html(""+e)}),socket.on("end exam",function(){return i()}),r(".button").click(function(){return"0:00"===r(".timer").html()?!1:(socket.emit("toggle exam",!0),o(r(".button").html()))})})},{jquery:1}]},{},[2])
