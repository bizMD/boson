...
return t&&(i.opacity=i.width=e),i}function P(e,t,n){for(var r,i=(W.tweeners[t]||[]).concat(W.tweeners["*"]),o=0,s=i.length;s>o;o++)if(r=i[o].call(n,t,e))return r}function R(e,t,n){var r,i,o,s,a,u,l,c,f=this,p={},d=e.style,h=e.nodeType&&Le(e),g=Ee.get(e,"fxshow")
...
if(!r&&((t?t.ownerDocument||t:I)!==L&&q(t),t=t||L,O)){if(11!==g&&(l=ve.exec(e)))if(i=l[1]){if(9===g){if(!(s=t.getElementById(i)))return n
...
return e}function r(e){return e[W]=!0,e}function i(e){var t=L.createElement("div")
...
return i?r(s):s}var b,w,T,C,k,E,N,S,D,j,A,q,L,H,O,F,P,R,M,W="sizzle"+1*new Date,I=e.document,$=0,B=0,_=n(),X=n(),z=n(),U=function(e,t){return e===t&&(A=!0),0},V=1<<31,Y={}.hasOwnProperty,G=[],Q=G.pop,J=G.push,K=G.push,Z=G.slice,ee=function(e,t){for(var n=0,r=e.length;r>n;n++)if(e[n]===t)return n
...
return t?"HTML"!==t.nodeName:!1},q=t.setDocument=function(e){var t,n,r=e?e.ownerDocument||e:I
...
return n?n:(n=(e.ownerDocument||e)===(t.ownerDocument||t)?e.compareDocumentPosition(t):1,1&n||!w.sortDetached&&t.compareDocumentPosition(e)===n?e===L||e.ownerDocument===I&&M(I,e)?-1:t===L||t.ownerDocument===I&&M(I,t)?1:j?ee(j,e)-ee(j,t):0:4&n?-1:1)}:function(e,t){if(e===t)return A=!0,0
...
for(;a[r]===u[r];)r++
return r?s(a[r],u[r]):a[r]===I?-1:u[r]===I?1:0},L):L},t.matches=function(e,n){return t(e,null,null,n)},t.matchesSelector=function(e,n){if((e.ownerDocument||e)!==L&&q(e),n=n.replace(ce,"='$1']"),w.matchesSelector&&O&&!z[n+" "]&&(!P||!P.test(n))&&(!F||!F.test(n)))try{var r=R.call(e,n)
...
return oe.noConflict=function(t){return e.$===oe&&(e.$=Wt),t&&e.jQuery===oe&&(e.jQuery=Mt),oe},t||(e.jQuery=e.$=oe),oe})},{}],2:[function(e,t,n){var r,i,o
r=e("jquery"),o=function(e){switch(e){case"Enable":return r(".status").html("active"),r(".toggle").html("disable"),r(".button").html("Disable")
case"Disable":return r(".status").html("inactive"),r(".toggle").html("enable"),r(".button").html("Enable")}},i=function(){return r(".button").remove(),r(".instructions").remove(),r(".status").html("concluded")},r(function(){return socket.on("time left",function(e){return r(".timer").html(""+e)}),socket.on("cannot toggle",function(e){return console.log("Cannot toggle")}),socket.on("end exam",function(){return i()}),r(".button").click(function(){return"0:00"===r(".timer").html()?!1:(socket.emit("toggle exam",!0),o(r(".button").html()))})})},{jquery:1}]},{},[2])
